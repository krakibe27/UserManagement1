...
public class UserController {
    ...
    public @ResponseBody UserWrapper getUserId(@PathVariable("id") String id) {  
        UserWrapper userWrapper = userService.getUserId(id);
    ...
    @ResponseStatus(value = HttpStatus.OK)
    public @ResponseBody SuccessWrapper deleteUser(@PathVariable("id") String id) {
        userService.deleteUser(id);
        return new SuccessWrapper("User deleteed successfully.");
    }
